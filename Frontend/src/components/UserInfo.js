  ...
  return (
    <div className="w-full h-screen p-4">
      <div className="mb-4 w-full flex items-center">
        ...
        <label className="mr-4 font-extrabold">User</label>
        <input
          type="text"
        ...
        {[123, 124, 125, 126].map(id => (
          <li key={id} className="mb-4 p-4 bg-[#F2F2F2]">
            <div className="grid grid-cols-7 gap-4">
              ...
              <div className="flex items-center gap-2">
                <p>{id === 123 ? 'Ramesh' : id === 124 ? 'Geeta' : id === 125 ? 'Arun' : 'Soham'}</p>
              </div>
              <div className="flex items-center gap-2">
                <p>{id === 123 ? '45854957' : id === 124 ? '875885897' : id === 125 ? '85858587' : '85857575'}</p>
              </div>
              <div className="flex items-center gap-2">
                <p>{id === 123 ? 'Ramesh@gmail.com' : id === 124 ? 'Geeta@gmail.com' : id === 125 ? 'Arun@gmail.com' : 'Soham@gmail.com'}</p>
              </div>
              <div className="flex items-center gap-2">
